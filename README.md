...
names. If the free design drifted, deploy `research/notes_app.sql` into the sandbox
before Step 4 so the API and app run on the schema they were written for.
